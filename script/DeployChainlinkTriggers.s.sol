...
contract DeployChainlinkTriggers is ScriptUtils {
  ...
  ChainlinkTriggerFactory factory = ChainlinkTriggerFactory(0x5b73D0991d9868732815B0406e2f21b223b07Bc9);
  ...
  function _deployTrigger(ChainlinkMetadata memory _metadata) internal {
    ...
    // Loosely validate oracle interfaces by ensuring `description()` doesnt't revert.
